        ...
        <main className={styles.lEntry}>
          <article className={styles.entry}>
            <div className={styles.entryHeader}>
              ...
              <div className={styles.entryHeaderCategory}><Label category={frontmatter.category}/></div>
              <div className={styles.entryHeaderImg}><img src="/assets/img/dummy.jpg" alt="" /></div>
            </div>
